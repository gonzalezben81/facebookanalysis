...
sentiment<- params$sentiment
    ...
    text(barplot_one, 0,labels = sort(round(colSums(prop.table(value[, 1:8])),digits = 2),decreasing = T),cex=1,pos=3)
    }
...
text(barplot_one, 0,labels = sort(round(colSums(prop.table(value[, 9:10])),digits = 2),decreasing = TRUE),cex=1,pos=3)
    }
```
